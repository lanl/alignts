...
!
!
SUBROUTINE e_step(ncores,K,M,Q,N,n_tau,n_scale,x,z,states,noise,init_n,init_t_range,u,phi,t_tau, &
...
DO kk=1,K
    ...
    DO i=1,N
        ...
        IF(prob_sum .LE. 0) THEN
            write(*,*) 'All states have zero probability for observation', i
            write(*,*) 'in series', kk
        ENDIF
